...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Rebuild memory/derived_memory.sqlite3 from raw_events.jsonl.",
    )
    parser.add_argument(
        "--raw-events-jsonl",
    ...
    parser.add_argument(
        ...
        help="Kept for path visibility; rebuild reads the append-only JSONL.",
    )
    parser.add_argument(
        "--derived-db",
...
def main():
    args = parse_args()
    raw_events = read_raw_events(args.raw_events_jsonl)
