...
def get_item_delta_checkpoint(
    *,
    ...
    prohibited_observed = delta < 0
    return {
        "reason": (
            "target inventory delta verified"
            if expected_verified
            else "target inventory delta did not meet the requested amount"
        ),
        ...
        "unexpected_effect_observed": prohibited_observed,
        "prohibited_effect_absence_verified": not prohibited_observed,
    }
