...
def download_and_extract_zip(url, extract_to='.', folder_name=None):
    ...
    """
    log_print(f"Downloading from {url}.")#20260612_kpopmodder
    try:
        ...
        log_print(f"An error occurred while downloading the file: {e}")#20260612_kpopmodder
    except zipfile.BadZipFile:
        log_print("The downloaded file is not a zip file or it is corrupted.")#20260612_kpopmodder
