...
// //20260711_kpopmodder: Copied into a LAN Lobby-specific server entrypoint so
// // future remote-human/LAN multiplayer changes do not expand the original
// // Sc2LadderServer or Local Match launcher paths.
// #include <algorithm>
// #include <cctype>
// #include <cstdlib>
// #include <iostream>
...
// {
//     std::cout
//         << "LavLanLadderServer - LAN Lobby remote human vs ProBots launcher\n"
//         << "Usage:\n"
//         << "  LavLanLadderServer.exe --human-name RemoteHuman --bot changeling --map PersephoneLE.SC2Map --race Protoss --bot-dir Bots/ --config HumanLadder.json --remote-human-host 192.168.0.20 --remote-human-client-port 5679 --lan-game-host-ip 192.168.0.10\n\n"
...
//     {
//         std::cerr << "[LavLanLadderServer] Missing required remote human endpoint. "
...
//     {
//         std::cerr << "[LavLanLadderServer] Unable to parse config: " << configPath << std::endl;
//         return 2;
//     }
...
//     {
//         std::cerr << "[LavLanLadderServer] Unable to find bot: " << botName << " in " << botDirectory << std::endl;
//         return 3;
//     }
...
//     std::cout << "[LavLanLadderServer] Starting LAN remote human " << human.BotName
//               << " vs " << bot.BotName
//               << " on " << mapName
...
//     std::cout << "[LavLanLadderServer] Finished with result: " << GetResultType(result.Result) << std::endl;
