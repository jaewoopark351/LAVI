...
class Proxy
{
    ...
    //20260710_kpopmodder: Throttle AI-only ResponseObservation telemetry so
    // the proxy stdout reader and TTS pipeline are not flooded.
    uint32_t m_lastTelemetryGameLoop{0U};
