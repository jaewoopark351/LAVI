...
public:
    ...
    GameResult StartLanRemoteHumanGame(const BotConfig & RemoteHumanAgent, const BotConfig & BotAgent, const std::string & Map, const std::string & RemoteHumanHost, int RemoteHumanClientPort);
