...
#20260713_kpopmodder: Temporary/state-only units stay resolvable so telemetry
# does not degrade into unknown_unit_* while keeping the speech registry stable.
...
SC2_LEGACY_UNIT_TYPE_ID_BY_TOKEN = SC2_LOG_ONLY_UNIT_TYPE_ID_BY_TOKEN
SC2_LOG_ONLY_UNIT_TYPE_TOKEN_BY_ID = {
    unit_type_id: token
    for token, unit_type_id in SC2_LOG_ONLY_UNIT_TYPE_ID_BY_TOKEN.items()
}
...
SC2_LOG_ONLY_UNIT_TOKENS = frozenset(SC2_LOG_ONLY_UNIT_TYPE_ID_BY_TOKEN)
...
SC2_LOG_ONLY_UNIT_TYPE_IDS = frozenset(SC2_LOG_ONLY_UNIT_TYPE_ID_BY_TOKEN.values())
