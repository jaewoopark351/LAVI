...
class VoiceVox(TTSPluginInterface):
    ...
    def init(self):
        ...
        if not os.path.exists(self.voicevox_engine_directory):
            ...
            if response.status_code == 200:
                ...
                log_print(f"{file_name} extracted to VoicevoxEngine successfully.")#20260612_kpopmodder
        ...
        log_print("initializing voicevox...")#20260612_kpopmodder
    ...
    def on_speaker_change(self, choice):
        ...
        self.selected_style = self.current_styles[0]
        log_print(f"Changed speaker ID to: {self.selected_style['id']}")#20260612_kpopmodder
