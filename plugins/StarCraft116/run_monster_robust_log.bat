...
REM ============================================================
REM Monster BWAPI launcher with robust data-file placement + log
REM Put this .bat in the same folder as Monster.exe.
REM ============================================================
...
echo.
echo ===============================================
echo Monster launcher with log
...
echo %LOG_FILE%
echo.
echo After this, run Chaoslauncher as administrator with BWAPI 4.2.0 RELEASE enabled.
echo.
