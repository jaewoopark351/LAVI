...
class SourceModuleHnNSF(torch.nn.Module):
    ...
    def forward(self, x: torch.Tensor, upp: int = 1):
        ...
        # log_print(x.dtype,sine_wavs.dtype,self.l_linear.weight.dtype)#20260612_kpopmodder
        # if self.is_half:
        #     sine_wavs = sine_wavs.half()
        # sine_merge = self.l_tanh(self.l_linear(sine_wavs.to(x)))
        # log_print(sine_wavs.dtype,self.ddtype)#20260612_kpopmodder
...
class SynthesizerTrnMs256NSFsid(nn.Module):
    ...
    def forward(
        ...
        # log_print(1,pitch.shape)#[bs,t]#20260612_kpopmodder
        ...
        # log_print(-1,pitchf.shape,ids_slice,self.segment_size,self.hop_length,self.segment_size//self.hop_length)#20260612_kpopmodder
        pitchf = commons.slice_segments2(pitchf, ids_slice, self.segment_size)
        # log_print(-2,pitchf.shape,z_slice.shape)#20260612_kpopmodder
...
class MultiPeriodDiscriminator(torch.nn.Module):
    ...
    def forward(self, y, y_hat):
        ...
        for i, d in enumerate(self.discriminators):
            ...
            #     log_print(i,j,y.shape,y_hat.shape,fmap_r[j].shape,fmap_g[j].shape)#20260612_kpopmodder
            y_d_rs.append(y_d_r)
            y_d_gs.append(y_d_g)
