...
class TwitchChatFetch(InputPluginInterface):
    ...
    def stop_read_chat_twitch(self):
        log_print("Stopping chat fetch.")#20260612_kpopmodder
    ...
    class Bot(commands.Bot):
        ...
        async def event_ready(self):
            ...
            log_print(f'Logged in as | {self.nick}')#20260612_kpopmodder
            log_print(f'User id is | {self.user_id}')#20260612_kpopmodder
        ...
        async def event_message(self, message):
            ...
            if message.author.name not in self.excluded_users_list:
                log_print(message)#20260612_kpopmodder
                log_print(message.content)#20260612_kpopmodder
                log_print(message.author.name, ": ", message.content)#20260612_kpopmodder
