#20260907_kpopmodder: Carry one generalized command terminal response to presentation sinks.
...
class CommandLifecycleTerminalResponse:
    text: str
    event_id: str
    command_name: str
    ...
    def __post_init__(self) -> None:
        ...
        if type(self.command_name) is not str or self._COMMAND_NAME.fullmatch(self.command_name) is None:
            raise ValueError("command terminal response command_name is invalid")
...
__all__ = ("CommandLifecycleTerminalResponse",)
