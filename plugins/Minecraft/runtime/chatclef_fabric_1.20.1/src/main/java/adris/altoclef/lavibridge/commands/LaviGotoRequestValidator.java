...
//20260725_kpopmodder: Added this validator to keep goto target parsing separate from command text creation.

import java.util.Map;

public class LaviGotoRequestValidator {

    public LaviGotoRequest validate(Map<String, Object> request) {
        return new LaviGotoRequest(normalizeGotoTarget(request), request);
    }
