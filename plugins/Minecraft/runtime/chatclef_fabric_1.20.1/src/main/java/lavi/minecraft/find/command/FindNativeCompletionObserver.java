...
//$$     }
//$$     public void bind(UserRootLifetime lifetime) { this.lifetime = lifetime; log("BOUND", lifetime == null ? "unavailable_root_lifetime" : "matching_root_lifetime"); }
...
//$$         if (present) {
//$$             String response = resourceMatched ? FindNativeResultRenderer.render(outcome)
