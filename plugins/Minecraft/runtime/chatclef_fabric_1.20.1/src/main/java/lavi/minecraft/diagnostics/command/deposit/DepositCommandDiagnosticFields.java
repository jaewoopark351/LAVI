...
final class DepositCommandDiagnosticFields {
    ...
    static Object[] invocationFields(AltoClef mod,
        ...
        return mergeFields(new Object[]{
                ...
                "dedupe_key", "deposit_command_invocation|" + resolvedVariant.commandName() + "|" + identity(taskToRun),
                "max_emission", "one_per_deposit_command_invocation",
                "correlation", "taskToRunIdentity=" + identity(taskToRun),
                "payload", "flat_fields",
                "terminal", false,
                "behavior_effect", "none",
                "commandName", resolvedVariant.commandName(),
                "commandRequestSource", resolvedVariant.requestSource(),
