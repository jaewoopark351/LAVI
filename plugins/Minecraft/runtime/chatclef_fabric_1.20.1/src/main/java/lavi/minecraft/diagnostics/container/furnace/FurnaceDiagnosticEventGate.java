...
//20260807_kpopmodder: Bound furnace arbitration diagnostics without changing container task behavior.
final class FurnaceDiagnosticEventGate {
    ...
    private FurnaceDiagnosticEventGate() {
    }
