...
//20260814_kpopmodder: Bound kill-and-loot progress diagnostics without changing resource behavior.
final class KillAndLootDiagnosticEventGate {
    ...
    private KillAndLootDiagnosticEventGate() {
    }
