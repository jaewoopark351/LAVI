...
final class ExistingCancelBoundaryDiagnostics {
    ...
    static void log(AltoClef mod,
        ...
        String fingerprint = MiningDiagnosticEmitter.joinFingerprint(
                ...
                before.pathPresent,
                after.baritonePathing,
                after.customGoalActive,
                after.pathPresent
        );
        MiningDiagnosticEmitter.emit("BARITONE_EXISTING_CANCEL_BOUNDARY", "baritone_existing_cancel_boundary", task,
                ...
                }, SubmittedGoalDiagnosticState.fields(submittedGoal, target), before.fields("Before"), after.fields("After")));
    }
}
